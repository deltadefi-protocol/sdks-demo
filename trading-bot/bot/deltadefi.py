    ...
    def __init__(
        ...
        if self.trading_password:
            try:
                ...
                raise ValueError(f"Failed to load operation key: {e}")
        else:
            logger.warning("No trading password provided - order submission will not work")
...
class AccountWebSocket:
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            self._client.websocket.register_handler("account", self._handle_account_message)
